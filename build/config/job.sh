...
sbatch -J job --export=JOB_CWD=.,JOB_ENV=tensor,JOB_MODULES="python hdf5 cuda cudnn",JOB_SRC=~/code/tensor/src,JOB_CMD=train.py,JOB_PROCESSES=1,JOB_ARGS=settings.json,NUMPY_BACKEND=jax < job.slurm
