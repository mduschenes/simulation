...
- *Distributions of Noisy Expectation Values over Sets of Measurement Operators*, found on [arXiv](https://doi.org/10.48550/arXiv.2604.05973), or [PRA](https://doi.org/10.1103/qp99-qqgy) and data can be found in the [Zenodo repository](https://doi.org/10.5281/zenodo.18671768). Please refer to branch `tensor` for tensor network simulation code.
