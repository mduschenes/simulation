function GRinfo  = saveGRstr_state(gra,str_name)
if nargin<1
    disp('  ')
...
GRinfo.RHO_init = gra.RHO_in;
GRinfo.RHOtarg=gra.RHO_targ;
GRinfo.Usim=gra.Usim*(gra.Ud)';
GRinfo.RHOsim = GRinfo.Usim*gra.RHO_in*GRinfo.Usim';
